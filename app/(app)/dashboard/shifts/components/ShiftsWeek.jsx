              ...
              {DAYS_SHORT.map((d, i) => (
                <button
                  ...
                  style={{
                    ...
                    height: 24,
                    borderRadius: 6,
                    border: selectedDay === i ? '2px solid var(--pink-500)' : '1px solid var(--gray-200)',
                    background: selectedDay === i ? 'var(--pink-50)' : 'var(--gray-0)',
                    color: selectedDay === i ? 'var(--pink-500)' : 'var(--gray-400)',
                    fontSize: 9,
                    fontWeight: 600,
                    cursor: 'pointer',
                  }}
